...
class GRPOConfig(TrainingArguments):
    ...
    Parameters:
        ...
        tensor_parallel_size (`int`, *optional*, defaults to `None`):
            Number of GPUs to use for tensor parallelism in vLLM. If None, vLLM will use a single GPU.
        max_model_len (`int`, *optional*, defaults to `8192`):
            Maximum sequence length for vLLM. This includes both prompt and completion tokens.
    ...
    tensor_parallel_size: Optional[int] = field(
        default=None,
        metadata={
            "help": "Number of GPUs to use for tensor parallelism in vLLM. If None, vLLM will use a single GPU."
        },
    )
    max_model_len: Optional[int] = field(
        default=8192,
        metadata={
            "help": "Maximum sequence length for vLLM. This includes both prompt and completion tokens."
        },
    )
